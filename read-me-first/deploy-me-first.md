...
This folder contains the cumulative WorkRightsUK build through Batch 78.
...
- you can optionally run `python scripts/verify_static_site.py` for a quick local check before deploy
...
- spot-check one page for canonical, title, description and JSON-LD presence
